...
implements GLSurfaceView.EGLConfigChooser {
 ...
 EGL10.EGL_STENCIL_SIZE, 8,
		...
		for ( int i = 0; i < configs.length; ++i ) {
			 ...
			 * "configchooser", "red " + findConfigAttrib( egl, display,
			 * configs[i], EGL10.EGL_RED_SIZE, 0 ) ); Log.i( "configchooser",
			 * "green " + findConfigAttrib( egl, display, configs[i],
			 * EGL10.EGL_GREEN_SIZE, 0 ) ); Log.i( "configchooser", "blue " +
			 * findConfigAttrib( egl, display, configs[i], EGL10.EGL_BLUE_SIZE,
			 * 0 ) ); Log.i( "configchooser", "alpha " + findConfigAttrib( egl,
			 * display, configs[i], EGL10.EGL_ALPHA_SIZE, 0 ) ); Log.i(
			 * "configchooser", "depth " + findConfigAttrib( egl, display,
			 * configs[i], EGL10.EGL_DEPTH_SIZE, 0 ) ); Log.i( "configchooser",
			 * "stencil " + findConfigAttrib( egl, display, configs[i],
			 * EGL10.EGL_STENCIL_SIZE, 0 ) ); Log.i( "configchooser",
			 * "samplebufs " + findConfigAttrib( egl, display, configs[i],
			 * EGL10.EGL_SAMPLE_BUFFERS, 0 ) ); Log.i( "configchooser",
			 * "samples " + findConfigAttrib( egl, display, configs[i],
			 * EGL10.EGL_SAMPLES, 0 ) );
			 */
