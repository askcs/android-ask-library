...
/**
 * Base class for RestReceiver implementations. Provides a
 * {@link #getConnection(String)} method to perform a call to the ASK REST API.
 * 
...
public abstract class BaseRestReceiver implements RestReceiver {
  ...
  protected InputStream getConnection( String httpUrl ) {
    ...
    try {
      ...
      Log.e( TAG, "Failed to communicate with ASK API at "
          + mRestInterface.mHost + " : " + e.getClass().getName() );
      e.printStackTrace();
      return null;
    }
  }
