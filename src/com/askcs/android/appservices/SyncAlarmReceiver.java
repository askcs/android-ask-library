...
/**
 * Receives broadcast intents from the AlarmManager even when the application is
 * not running. After receiving the intent the AlarmReceiver will launch
 * {@link AppServiceService} to process the {@link RestCache} and check for
 * updates.
 * 
 * @author Ian Zwanink
 */
public class SyncAlarmReceiver extends BroadcastReceiver {
  ...
  public void onReceive( Context context, Intent intent ) {
    ...
    try {
      ...
      Intent sync = new Intent( Intent.ACTION_SYNC, null, context,
