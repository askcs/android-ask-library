...
public class Storage extends SqlStorageBase {
	...
	public static final String C_SUBSTANCE_COUNT = "COUNT";
		...
		public void onCreate(SQLiteDatabase db) {
			db.execSQL("create table " + T_NOTE + " (" + C_NOTE_ID
					...
					+ " integer," + C_NOTE_CONTENT + " text," + C_NOTE_TIMESTAMP
					+ " text)");
			
			

			db.execSQL("create table " + T_RHYTHM + " (" + C_RHYTHM_ID
					+ " integer primary key autoincrement, " + C_RHYTHM_TIME
					+ " integer," + C_RHYTHM_KEY + " text," + C_RHYTHM_CONTENT
					+ " text)");
			
			db.execSQL("create table " + T_RHYTHMACTIVITY + " (" + C_RHYTHMACTIVITY_ID
					+ " integer primary key autoincrement, " + C_RHYTHMACTIVITY_KEY + " text," + C_RHYTHMACTIVITY_NAME
					+ " text,"+ C_RHYTHMACTIVITY_TOPTEXT + " text," + C_RHYTHMACTIVITY_BOTTOMTEXT +  " text)");
			...
			db.execSQL("create table " + T_SUBSTANCEACTIVITY + " (" + C_SUBSTANCEACTIVITY_ID
					+ " integer primary key autoincrement, " + C_SUBSTANCEACTIVITY_KEY + " text unique)");
	...
	public boolean populateRhythmActivity() {
		...
		try {
				...
				contentValues.put(C_RHYTHMACTIVITY_TOPTEXT, "Uw eerste contact met een andere persoon was %s om");
				...
				contentValues.put(C_RHYTHMACTIVITY_TOPTEXT, "U bent %s met uw dagactiviteit begonnen om");
				db.insert(T_RHYTHMACTIVITY, null, contentValues);
				contentValues = new ContentValues();
				contentValues.put(C_RHYTHMACTIVITY_KEY, "dinner");
				contentValues.put(C_RHYTHMACTIVITY_NAME, "Avondeten");
				contentValues.put(C_RHYTHMACTIVITY_TOPTEXT, "U heeft %s uw avondeten genuttigd om");
				db.insert(T_RHYTHMACTIVITY, null, contentValues);
				contentValues = new ContentValues();
				contentValues.put(C_RHYTHMACTIVITY_KEY, "event");
				contentValues.put(C_RHYTHMACTIVITY_NAME, "Ingrijpende gebeurtenis");
				contentValues.put(C_RHYTHMACTIVITY_TOPTEXT, "Er vond %s een ingrijpende gebeurtenis plaats om");
				contentValues.put(C_RHYTHMACTIVITY_BOTTOMTEXT, "Vult u in waar het om ging, bijvoorbeeld een ruzie, een ruzie bijgelegd, een viering, of iets anders wat u beinvloed heeft.");
				db.insert(T_RHYTHMACTIVITY, null, contentValues);
