...
public class GcmManager {
    ...
    public void register() {
        ...
        final String regId = GCMRegistrar.getRegistrationId(mContext.getApplicationContext());
        Log.i(TAG, "regid:" + regId);
        if (regId.equals("") || !GCMRegistrar.isRegisteredOnServer(mContext.getApplicationContext())) {
    ...
    public void unregister() {
        ...
        GCMRegistrar.setRegisteredOnServer(mContext.getApplicationContext(), false);
    }
}
