...
public class Message implements Parcelable {
  ...
  public Message( String uuid, String subject, String questionText,
      String type, long creationTime, String state ) {
    setUuid( uuid );
    setSubject( subject );
  ...
  public Message( int id, String uuid, String subject, String questionText,
      String type, long creationTime, String state ) {
    setId( id );
    setUuid( uuid );
    setSubject( subject );
  ...
  public ContentValues toContentValues() {
    ...
    if ( mId != 0 ) {
      contentValues.put( AppServiceSqlStorage.C_MESSAGE_ID, mId );
    }
    ;
    ...
    contentValues.put( AppServiceSqlStorage.C_MESSAGE_QUESTION_TEXT,
        mQuestionText );
    contentValues.put( AppServiceSqlStorage.C_MESSAGE_TYPE, mType );
    contentValues.put( AppServiceSqlStorage.C_MESSAGE_STATE, mState );
    contentValues.put( AppServiceSqlStorage.C_MESSAGE_CREATIONTIME,
        mCreationTime );
